-- Actualizar tabla de disponibilidad para horarios específicos
...
ALTER TABLE availability ADD COLUMN IF NOT EXISTS event_name TEXT;

-- Actualizar tabla de bookings para incluir campos faltantes
